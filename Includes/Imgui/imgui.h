...
namespace ImGui
{
    ...
    //   If you get a warning converting a float to ImGuiSliderFlags, read https://github.com/Ilyes009
    ...
    // - Consider using ImPlot (https://github.com/Ilyes009 which is much better!
...
struct ImFontConfig
{
    ...
    int             OversampleH;            // 3        // Rasterize at higher quality for sub-pixel positioning. Note the difference between 2 and 3 is minimal so you can reduce this to 2 to save memory. Read https://github.com/Ilyes009 for details.
